...
CREATE TABLE IF NOT EXISTS investment_period_inputs (
    ...
    CONSTRAINT fk_investment_inputs_creator FOREIGN KEY (household_id, created_by_user_id) REFERENCES household_members(household_id, user_id) ON DELETE RESTRICT,
