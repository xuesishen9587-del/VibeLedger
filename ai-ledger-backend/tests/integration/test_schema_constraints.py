...
class TestSchemaConstraints(BaseDbTestCase):
    def test_required_not_null_column_rejections(self):
        ...
        test_null_inserts = [
            ...
            ("devices", "INSERT INTO devices (id, household_id, user_id, name, platform, token_hash, status) VALUES (%s, %s, %s, %s, %s, %s, NULL);", (uuid.uuid4(), h_id, u_id, "D", "ios_shortcuts", b"t1")),
            ("devices", "INSERT INTO devices (id, household_id, user_id, name, platform, token_hash, status) VALUES (%s, %s, %s, %s, NULL, %s, %s);", (uuid.uuid4(), h_id, u_id, "D", b"t2", "active")),
